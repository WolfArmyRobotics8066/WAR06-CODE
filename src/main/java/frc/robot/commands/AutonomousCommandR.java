...
public class AutonomousCommandR extends SequentialCommandGroup {
    

    public AutonomousCommandR (TracaoSubsystem tracaoSubsystem, LauncherSubsystem launcherSubsystem, ColletorSubsystem colletorSubsystem){
        ...
        addCommands(new ParallelRaceGroup(new AutonomousMove(tracaoSubsystem, 0.7, 0)), new WaitCommand(2));
